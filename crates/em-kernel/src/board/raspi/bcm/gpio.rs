use tock_registers::{register_bitfields, register_structs, registers::ReadWrite, interfaces::ReadWriteable};

use crate::{sync::Mutex, driver::DeviceDriver};
...
impl GPIO {
    pub const NAME: &'static str = "BCM GPIO";
